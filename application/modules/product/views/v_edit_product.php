...
<div class="row">
    <div class="col-lg-8 grid-margin stretch-card col-sm-">
      <div class="card">
        <div class="card-body">
          <br>
          <form class="forms-sample" action="<?php echo base_url('product/updateProduct/'. $product['id']); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select name="kategori" id="kategori" class="form-control">
                ...
                <?php if($k['id']==$k['kategori']){
                echo '<option value="$k[kategori]"."selected".></option>';
                }?>
                <?php endforeach; ?>
              </select>
            </div>
