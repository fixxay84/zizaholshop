	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				...
				<form class="login100-form" method="post" action="<?php echo base_url('login') ?>">
					...
					<div class="text-center w-full p-t-50">
						<a class="txt1 bo1 hov1" href="<?php echo base_url('login/forgotPassword') ?>">
							Lupa Password?							
						</a>
					</div>
					...
					<div class="text-center w-full p-t-20">
						...
						<a class="txt1 bo1 hov1" href="<?php echo base_url('login/registrasi') ?>">
							Sign up now							
						</a>
					</div>
					<div class="text-center w-full p-t-20">
